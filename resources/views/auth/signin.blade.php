                    ...
                    <div class="sign">
                        <div class="sign__content">
                            ...
                            <form action="#" class="sign__form">
                                ...
                                <span class="sign__text">Нет аккаунта? <a href="{{route('auth.signup.get')}}">Регистрация!</a></span>

                                <span class="sign__text"><a href="{{route('auth.forgot.get')}}">Забыли пароль?</a></span>
