...
<header class="header">
    <div class="header__content">
        <div class="header__logo">
            <a href="<?php echo e(route('staticpages.home')); ?>">
        ...
        <?php if(True): ?>
            <div class="header__action header__action--signin">
                <a class="header__action-btn" href="<?php echo e(route('auth.signin.get')); ?>">
                    <span>Войти</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<div class="sidebar">
    ...
    <ul class="sidebar__nav" style="padding: 30px 0 0;">
        <?php if(request()->route()->getName() == 'staticpages.home'): ?>
            <li class="sidebar__nav-item">
                <a href="<?php echo e(route('staticpages.home')); ?>" class="sidebar__nav-link sidebar__nav-link--active">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <?php else: ?>
            <li class="sidebar__nav-item">
                <a href="<?php echo e(route('staticpages.home')); ?>" class="sidebar__nav-link sidebar__nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M20,8h0L14,2.74a3,3,0,0,0-4,0L4,8a3,3,0,0,0-1,2.26V19a3,3,0,0,0,3,3H18a3,3,0,0,0,3-3V10.25A3,3,0,0,0,20,8ZM14,20H10V15a1,1,0,0,1,1-1h2a1,1,0,0,1,1,1Zm5-1a1,1,0,0,1-1,1H16V15a3,3,0,0,0-3-3H11a3,3,0,0,0-3,3v5H6a1,1,0,0,1-1-1V10.25a1,1,0,0,1,.34-.75l6-5.25a1,1,0,0,1,1.32,0l6,5.25a1,1,0,0,1,.34.75Z"></path>
                    </svg>
                    <span>Главная</span>
        ...
        <?php endif; ?>
            ...
            <?php if(request()->route()->getName() == 'authors.review'): ?>
                <li class="sidebar__nav-item">
                    <a href="<?php echo e(route('authors.review')); ?>" class="sidebar__nav-link sidebar__nav-link--active">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <?php else: ?>
                <li class="sidebar__nav-item">
                    <a href="<?php echo e(route('authors.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M12.3,12.22A4.92,4.92,0,0,0,14,8.5a5,5,0,0,0-10,0,4.92,4.92,0,0,0,1.7,3.72A8,8,0,0,0,1,19.5a1,1,0,0,0,2,0,6,6,0,0,1,12,0,1,1,0,0,0,2,0A8,8,0,0,0,12.3,12.22ZM9,11.5a3,3,0,1,1,3-3A3,3,0,0,1,9,11.5Zm9.74.32A5,5,0,0,0,15,3.5a1,1,0,0,0,0,2,3,3,0,0,1,3,3,3,3,0,0,1-1.5,2.59,1,1,0,0,0-.5.84,1,1,0,0,0,.45.86l.39.26.13.07a7,7,0,0,1,4,6.38,1,1,0,0,0,2,0A9,9,0,0,0,18.74,11.82Z"></path>
                        </svg>
                        <span>Артисты</span>
        ...
        <li class="sidebar__nav-item">
            <a href="<?php echo e(route('albums.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
        ...
        <li class="sidebar__nav-item">
            <a href="<?php echo e(route('genres.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li class="sidebar__nav-item">
            <a href="<?php echo e(route('charts.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
        ...
        <li class="sidebar__nav-item">
            <a href="<?php echo e(route('podcasts.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li class="sidebar__nav-item">
            <a href="<?php echo e(route('audiobooks.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
        ...
        <li class="sidebar__nav-item">
            <a href="<?php echo e(route('broadcasts.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
        ...
        <li class="sidebar__nav-item">
            <a href="<?php echo e(route('news.review')); ?>" class="sidebar__nav-link sidebar__nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<?php /**PATH C:\OSPanel\domains\volna\resources\views/layouts/app.blade.php ENDPATH**/ ?>